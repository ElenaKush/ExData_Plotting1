...
## Plot with coordinates 1x2
with(df1, plot(DateAndTime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))

## Plot with coordinates 2x2
with(df1, plot(DateAndTime, Global_reactive_power, type = "l", xlab = "datetime"))
